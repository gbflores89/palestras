...
\begin{frame}
	...
	\begin{columns}[c] % The "c" option specifies centered vertical alignment while
		...
		\begin{itemize}
			\item <1-> Qualquer programa que transforme um sistema real em um sistema de
			equações.
			\begin{itemize}
				\item <2->Resolvemos por cálculos feitos à mão ou por programas
				computacionais
			\end{itemize}
		\end{itemize}

		\column{.5\textwidth} % Right column and width
			\includegraphics<1->[width=0.95\textwidth]{img/Molecular_simulation_process.png}
	\end{columns}
\end{frame}
