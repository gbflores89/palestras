...
%------------------------------------------------
\section{Introdução} % Sections can be created in order to organize your
...
\begin{frame}
	\frametitle{O que é um simulador de processos?}
	\begin{itemize}
...
\begin{frame}
	...
	\begin{columns}[c] % The "c" option specifies centered vertical alignment while
		...
		\column{.5\textwidth} % Right column and width
			\includegraphics[width=0.9\textwidth]{img/Molecular_simulation_process.png}
	\end{columns}
\end{frame}
